...
Фокус проекта: микросервисная архитектура, интеграция через RabbitMQ и агрегация внешних данных.
Система рассчитана на одного куратора — без авторизации и мультитенантности.  
